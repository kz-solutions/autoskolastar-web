...
const Hero = () => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="w-full max-w-[100vw] h-screen px-0 md:px-6 lg:px-20! pb-0! md:pb-12! lg:pb-16! pt-0! md:pt-24! mb-12 md:mb-0 relative flex justify-center box-border"
    >
